    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="100">
        <div class="container">
            <div class="navbar-translate">
				...
				<a class="navbar-toggler navbar-toggler" href="http://demos.creative-tim.com/now-ui-kit/index.html" rel="tooltip" title="Designed by Invision. Coded by Creative Tim" data-placement="bottom" target="_blank">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="/assets2/img/blurred-image-1.jpg">
                <ul class="navbar-nav" style="padding: 0 1%;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-neutral" href="<?php echo base_url().$nav_pengumuman; ?>">
					...
					<li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url().$nav_about; ?>">
                            <!--<i class="now-ui-icons files_paper"></i>-->
                            <p><b>ABOUT US</b></p>
                        </a>
                    </li>
			...
			<?php } ?>
				...
				<a class="collapse2" href="http://demos.creative-tim.com/now-ui-kit/index.html" rel="tooltip" title="Designed by Invision. Coded by Creative Tim" data-placement="bottom" target="_blank">
					<img src="/assets2/img/wika-logo_blue.png" class="creative-tim-logo" />
				</a>
            </div>
					...
					<div >
						...
						<div class="card">
							<div class="card-body">
								...
								<?php echo form_open_multipart('pengumuman/index'); ?>
									<div class="row" style="width:40%; " align="right">
										<div class="col-md-8" align="right">
											<input id="cari" name="cari" type="text" value="<?php echo $cari; ?>" placeholder="Isi disini..." class="form-control" />
										</div>
																					
										<div class="col-md-2" align="left" style="margin-left: -20px; margin-top: -8px;">
											<button class="btn btn-primary btn-round" type="submit" name="submit">SEARCH</button>
										</div>
									</div>
								</form>
								</div>
        ...
        <div class="main">
			...
			<div class="section" data-background-color="blue" style="padding :20px 0px;">
                <div class="container text-center" style="height :80%;">
					...
					<div class="text-center">
						<a target="_blank" href="https://www.twitter.com/creativetim" class="btn btn-neutral btn-icon btn-twitter btn-round " rel="tooltip" title="Follow us">
							<i class="fa fa-twitter"></i>
						</a>
						<a target="_blank" href="https://www.facebook.com/creativetim" class="btn btn-neutral btn-icon btn-facebook btn-round " rel="tooltip" title="Like us">
							<i class="fa fa-facebook-square"></i>
						</a>
						<a target="_blank" href="https://www.linkedin.com/company-beta/9430489/" class="btn btn-neutral btn-icon btn-linkedin btn-round" rel="tooltip" title="Follow us">
							<i class="fa fa-instagram"></i>
						</a>
						<a target="_blank" href="https://github.com/creativetimofficial/now-ui-kit" class="btn btn-neutral btn-icon btn-github btn-round " rel="tooltip" title="Subscribe us">

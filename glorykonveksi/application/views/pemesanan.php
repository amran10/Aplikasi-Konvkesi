        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="./assets2/img/Astronout.jpg">
                <ul class="navbar-nav" style="padding: 0 1%;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-neutral" href="<?php echo base_url()."c_pemesanan"; ?>">
				...
				<div class="row">
					<div class="col-md-12" align="center">
						...
						<nav class="navbar navbar-expand-lg bg-info">
							<h3 style="width:100%; margin-bottom:0px; color:#ffffff;"><b>KONTAK</b></h3>
						</nav>
					</div>
				</div>
			</div> -->
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="tab-content text-center">
									...
									<?php echo form_open_multipart('kontak/kirim_email'); ?>
										...
										<div class="row" style="width:100%; padding-top : 8px;" align="center">
											...
											<div class="col-md-8" align="left">
												<input id="nama" name="nama" type="text" value="" placeholder="Isi disini..." class="form-control" />
											</div>
										</div>
										<div class="row" style="width:100%; padding-top : 8px;" align="center">
											...
											<div class="col-md-8" align="left">
												<input id="email" name="email" type="text" value="" placeholder="Isi disini..." class="form-control" />
											</div>
										</div>
										<div class="row" style="width:100%; padding-top : 8px;" align="center">
											...
											<div class="col-md-8" align="left">
												<input id="prihal" name="prihal" type="text" value="" placeholder="Isi disini..." class="form-control" />
											</div>
										</div>
										<div class="row" style="width:100%; padding-top : 8px;" align="center">
											<div class="col-md-2" align="left">
											...
											<div class="col-md-8" align="left">
												<textarea id="pesan" name="pesan" placeholder="Isi disini..." class="form-control" ></textarea>
											</div>
										</div>

								...
								<div class="tab-content text-center">
									...
									<div class="row">
										<div class="card card-signup" data-background-color="orange">
											...
											<form action='<?php echo base_url(); ?>n_login/login' method='post' onSubmit='return validasi(this);'>
												...
												<div class="card-body">
													<div class="input-group form-group-no-border">
														...
														<input type="text" name="username" class="form-control" placeholder="Masukan E-Mail Anda">
													</div>
													<div class="input-group form-group-no-border">
														<span class="input-group-addon">
													...
													<div class="g-recaptcha" data-sitekey="6Le6AXEUAAAAAMZh1d4Y1PljrFTXu_MhPBjDO4Sr"></div>												<!-- If you want to add a checkbox to this form, uncomment this code -->
													<!-- <div class="checkbox">

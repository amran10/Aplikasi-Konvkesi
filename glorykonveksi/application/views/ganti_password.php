								...
								<div class="tab-content text-center">
									...
									<div class="row">
										<div class="card card-signup" data-background-color="orange">
											<form action='<?php echo base_url(); ?>hal_data_diri/change'' method='post'>
												...
												<div class="card-body">
													<div class="input-group form-group-no-border">
														...
														<input id="password" name="password" type="password" class="form-control" placeholder="Password Anda">
													</div>
													<div class="input-group form-group-no-border">
														<span class="input-group-addon">
															<i class="now-ui-icons ui-1_lock-circle-open"></i>
													...
													<div class="input-group form-group-no-border">
														...
														<input id="c_n_password" name="c_n_password" type="password" class="form-control" placeholder="Confirm Password">
													</div>
												...
												<div class="footer">
													<div class="row" style="width:100%; margin:0px;" align="center">
														...
														<div class="col-md-4"><a href="<?php echo base_url()."hal_data_diri"; ?>" class="btn btn-neutral btn-round">Kembali</a></div>
														<button class="btn btn-neutral btn-round" type="submit" name="submit" >Simpan</button>
														<div class="col-md-2"></div>
													</div>

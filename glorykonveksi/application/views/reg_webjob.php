								...
								<div class="tab-content text-center">
									...
									<!--<div class="row">
										<div class="card card-signup" data-background-color="orange">
											<?php echo form_open_multipart('n_login/registrasi'); ?>
												<div class="header text-center">-->
													
									<div class="row">
										<div class="card card-signup" data-background-color="orange">
											<!--<?php echo form_open('n_login/login'); ?>-->
											<form action='<?php echo base_url(); ?>n_login/registrasi'' method='post' onSubmit='return validasi(this);'>
												<div class="header text-center">
												<!--
												...
												-->
													...
													<div class="input-group form-group-no-border">
														...
														<input id="email" name="email" type="text" class="form-control" placeholder="Masukan E-mail Anda">
													</div>
													<div class="input-group form-group-no-border">
														<span class="input-group-addon">
													...
													<div class="input-group form-group-no-border">
														...
														<input id="c_password" name="c_password" type="password" class="form-control" placeholder="Confirm Password">
													</div>
													<div class="g-recaptcha" data-sitekey="6LcWjz8UAAAAAJ2a3wcGsMCv_k9v1c9kTqh9ETA4"></div>
												...
												<div class="footer">
													<div class="row" style="width:100%; margin:0px;" align="center">
														...
														<button class="btn btn-neutral btn-round" type="submit" name="submit">Daftar</button>
														<div class="col-md-2"></div>
													</div>

...
<head>
    ...
    <!-- <script type="text/javascript">
        function validasi_lupa(){
            ...
            alert('Pastikan bahwa Anda bukan Robot !');
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="/assets2/img/blurred-image-1.jpg">
                <ul class="navbar-nav" style="padding: 0 1%;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-neutral" href="<?php echo base_url().$nav_login; ?>">
                            <!--<i class="now-ui-icons files_paper"></i>-->
                                ...
                                <div class="tab-content text-center">
                                    ...
                                    <div class="row">
                                        <div class="card card-signup" data-background-color="orange">
                                            <!--<?php echo form_open('n_login/lupa_password'); ?>-->
                                           <!--<form action='<?php echo base_url(); ?>n_login/lupa_password' method='post' onSubmit='return validasi(this);'>-->
                                            <form action='<?php echo base_url(); ?>n_login/lupa_password' name=f1 id=f1 method=post onSubmit='return validasi_lupa(this);'>
                                                ...
                                                <div align="justify-content-center">
                                                   <p><td align=center><h9>&nbsp;Silakkan masukkan Email yang Anda gunakan.&nbsp;</br>&nbsp; Kami Akan mengirimkan Password baru ke Email Anda. &nbsp;</h9></td></p>
                                                </div>
                                                <tr><td>&nbsp;</td></tr>
                                                <div class="card-body">
                                                    <div class="input-group form-group-no-border">
                                                        ...
                                                        <input type=text name=email value="" class="form-control" placeholder="Masukan E-Mail Anda" onBlur=check_email(this.value,'email');>
                                                    </div>
                                                    <tr><td>&nbsp;</td></tr>
                                                ...
                                                <div class="footer text-center">
                                                    <div class="row" style="width:100%; margin:0px;" align="center">
                                                        <div class="col-md-2"></div>
                                                        <div class="col-md-4"><a href="<?php echo base_url()."n_login"; ?>" class="btn btn-neutral btn-round">Kembali</a></div>
                                                        <button class="btn btn-neutral btn-round" type="submit" name="submit">Kirim</button>
                                                        <div class="col-md-2"></div>
                                                    </div>
                                                </div>
                                            </form>

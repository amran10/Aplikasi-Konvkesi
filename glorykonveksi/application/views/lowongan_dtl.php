			...
			<div class="container" id="menu-dropdown">
				<div class="row">
					<div class="col-md-12" align="center">
						...
						<nav class="navbar navbar-expand-lg bg-info">
							<h3 style="width:100%; margin-bottom:0px; color:#ffffff;"><b><u>LOWONGAN</u></b></h3>
						</nav>
					</div>
					<div class="col-md-12" align="center">
						<a href="<?php echo base_url().$link_r; ?>" class="<?php echo $class_r; ?>">REGULER</a>
						<a href="<?php echo base_url().$link_j; ?>" class="<?php echo $class_j; ?>">JOBFAIR</a>
					</div>
				</div>
				<div class="container" align="center" style="padding : 50px 0px;">
					...
					<?php foreach ($kota as $k) { ?>
						...
						<div class="col-sm-6">
							<a href="<?php echo base_url().$link_dtl2.'-o-'.$k->kd_kantor; ?>" target="">
								<img style="width:60%;" src="/assets2/img/kota3.svg" alt="Circle Image" class="rounded-circle img-raised">
								<div style="width:60%; margin-top:-110px; margin-bottom:120px;">
									<h3 style="color:#ffffff;"><b><?php echo $k->lokasi; ?></b></h3>
								</div>
								<!--<h3 style="margin-top:-40px; margin-bottom:200px; color:#ffffff;"><b>SHE</b></h3>-->
							</a>
						</div>
					...
					<div class="row">
						<div class="col-sm-6">
							<a href="<?php echo base_url().$link_dtl2."-jakarta"; ?>" target="">
								<img style="width:50%;" src="/assets2/img/jakarta.jpg" alt="Circle Image" class="rounded-circle img-raised">
							</a>
						</div>
						<div class="col-sm-6">
							<a href="<?php echo base_url().$link_dtl2."-bandung"; ?>" target="">
								<img style="width:50%;" src="/assets2/img/bandung.jpg" alt="Circle Image" class="rounded-circle img-raised">
							</a>
						</div>
					</div> 
					<div class="row" style="padding : 50px 0px;">
						<div class="col-sm-6">
							<a href="<?php echo base_url().$link_dtl2."-medan"; ?>" target="">
								<img style="width:50%;" src="/assets2/img/medan.jpg" alt="Circle Image" class="rounded-circle img-raised">
							</a>
						</div>
						<div class="col-sm-6">
							<a href="<?php echo base_url().$link_dtl2."-palembang"; ?>" target="">
								<img style="width:50%;" src="/assets2/img/palembang.jpg" alt="Circle Image" class="rounded-circle img-raised">
							</a>
						</div>
					</div> 
					-->

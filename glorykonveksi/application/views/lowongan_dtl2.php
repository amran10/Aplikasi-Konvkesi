				...
				<div class="container" align="center" style="padding : 0px 0px;">
					<div >
						...
						<div class="card">
							...
							<div class="row">
								<div class="col-md-6" align="left" style="padding-left:30px;">
									* Lokasi Test : <?php echo $kota." </br> Deadline ".$tgl_selesai; ?>
								</div>
								<div class="col-md-6" align="right" style="padding-right:30px;">
									<a href="<?php echo base_url().$link_apply; ?>" class="btn btn-primary btn-round btn-lg">APPLY</a>
								</div>
							</div>
						</div>
					</div>

			...
			?>
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<a class="dropdown-item" href="<?php echo base_url()."hal_data_diri"; ?>">CURRICULUM VITAE <b><?php echo $des_menu; ?></a></b>
							...
							<div id="dt_diri2"  style="margin-bottom: 10px;">
								...
								<div style="display:none;">
									...
									<div class="row" style="width:100%; padding-top : 8px; display : none;" id="fakul_">
										<div class="col-md-2"></div>
										<div class="col-md-4" align="left">
											PILIHAN FAKULTAS LAINNYA
										</div>
										<div class="col-md-4" align="left">
											<input id="fakultas_pil" name="fakultas_pil" type="text" value="" placeholder="Fakultas Lainnya" class="form-control" />
										</div>
										<div class="col-md-2"></div>
									</div>
									<div class="row" style="width:100%; padding-top : 8px;" align="center">
									...
									<div class="row" style="width:100%; padding-top : 8px; display : none;" id="jur_">
										<div class="col-md-2"></div>
										<div class="col-md-4" align="left">
											PILIHAN JURUSAN LAINNYA
										</div>
										<div class="col-md-4" align="left">
											<input  id="jurusan_pil" name="jurusan_pil" type="text" value="" placeholder="Jurusan Lainnya" class="form-control" />
										</div>
										<div class="col-md-2"></div>
									</div>
									<div class="row" style="width:100%; padding-top : 8px;" align="center">
										...
										<div class="col-md-2"></div>
										<div class="col-md-4" align="left">
											PILIHAN PROGRAM STUDI LAINNYA
										</div>
										<div class="col-md-4" align="left">
											<input id="prog_pil" name="prog_pil" type="text" value="" placeholder="Program Studi Lainnya" class="form-control" />
										</div>
										<div class="col-md-2"></div>
									</div>
									<div class="row" style="width:100%; padding-top : 8px;" align="center">
										...
										<div class="col-md-4" align="left">
											<input readonly="readonly" id="geglar" name="geglar" type="text" value="" placeholder="Isi disini..." class="form-control"
											onchange="
											if($(this).val()=='lain-lain'){
														$('#gelar_d').show();
													}else{
									...
									<!--<div class="row" style="width:100%; padding-top : 8px;" align="center">
										...
										<div class="col-md-4" align="left">
											...
											<select id="geglar" name="geglar" class="form-control"
											onchange="
													if($(this).val()=='lain-lain'){
														$('#gelar_d').show();
													}else{
									...
									<div class="row" style="width:100%; padding-top : 8px; display : none;" id="gelar_d">
										<div class="col-md-2"></div>
										<div class="col-md-4" align="left">
											PILIHAN GELAR LAINNYA
										</div>
										<div class="col-md-4" align="left">
											<input id="geglar_pil" name="geglar_pil" type="text" value="" placeholder="Gelar Lainnya" class="form-control" />
										</div>
										<div class="col-md-2"></div>
									</div>
									<!--<div class="row" style="width:100%; padding-top : 8px;" align="center">
								...
								<?php echo form_open_multipart('hal_data_diri/post_dt_kerja'); ?>
									...
									<div class="row" style="width:100%; padding-top : 8px;" align="center">
										...
										<div class="col-md-4" align="left">
											<input style="background-color : white;" Required id="thn_masuk_k" name="thn_masuk_k" type="text" class="form-control date-picker" value="<?php echo date('m/d/Y',strtotime($tgl_lahir)); ?>"  
											id="thn_masuk_k" name="thn_masuk_k">
									...
									<div class="row" style="width:100%; padding-top : 8px;" align="center">
										...
										<div class="col-md-4" align="left">
											<input style="background-color : white;" Required id="thn_keluar_k" name="thn_keluar_k" type="text" class="form-control date-picker" value="<?php echo date('m/d/Y',strtotime($tgl_lahir)); ?>"  
											id="thn_keluar_k" name="thn_keluar_k">

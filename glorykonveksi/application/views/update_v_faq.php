...
<!-- kalender -->
            ...
            <div class="container" id="menu-dropdown">
                ...
                <?php echo form_open_multipart('post_faq_backend'); ?>
					<?php foreach($faq_ as $k); ?>
				<div class="form-group">
					<label><b>Pertanyaan</b></label><br>
					<textarea type="text" id="pertanyaan" value="<?php echo $k->pertanyaan; ?>" name="pertanyaan" class="form-control" cols="40" rows="5" placeholder="Tulis Pertanyaan"></textarea>
					<label><b>Jawaban</b></label><br>
					<textarea type="text" id="Jawaban" value="<?php echo $k->jawaban; ?>" name="jawaban" class="form-control" cols="40" rows="5" placeholder="Tulis Jawaban"></textarea>
					<div class="col-md-12" align="center" style="padding-right:30px;">
						<button class="btn btn-primary btn-round" type="submit" name="edit">UPDATE</button>
					</div>
				</div>	
			</form>
					...
					<tbody>
					 <?php $a=1; foreach ($faq_ as $k) { ?> 
					  <tr>
						...
						<td><?php echo $k->jawaban; ?></td>
						<td align="center">
							<a hidden style="color:#79C753;" href="<?php echo base_url().$nav_beranda; ?>">
								<i class="fa fa-edit"></i>
							</a>&nbsp&nbsp
							<a href=""<?php echo form_open_multipart('admin_faq/update'); ?>
								<i class="fa fa-edit"></i>
							</a>&nbsp&nbsp

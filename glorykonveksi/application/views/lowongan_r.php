			...
			<div class="container" id="menu-dropdown">
				...
				<div class="container" align="center" style="padding : 50px 0px;">
					...
					<?php foreach ($posisi as $k) { ?>
						...
						<div class="col-sm-6">
							<a href="<?php echo base_url().$link_1.$k->req_id; ?>" target="">
								<img style="width:70%;" src="<?php echo $gmbr; ?>" alt="Circle Image" class="rounded-circle img-raised">
								<div style="width:60%; margin-top:-170px; margin-bottom:200px;">
									<h3 style="color:#ffffff;"><b><?php echo $k->posisi; ?></b></h3>
								</div>
					...
					<div class="row">
						<div class="col-sm-6">
							<a href="<?php echo base_url().$link_mtshe; ?>" target="">
								<img style="width:70%;" src="/assets2/img/mtshe.png" alt="Circle Image" class="rounded-circle img-raised">
								<h3 style="margin-top:-200px; color:#ffffff;"><b>MANAGEMENT TRAINEE</b></h3>
								<h3 style="margin-top:-40px; margin-bottom:200px; color:#ffffff;"><b>SHE</b></h3>
							</a>
							
						</div>
						<div class="col-sm-6">
							<a href="<?php echo base_url().$link_ppcp; ?>" target="">
								<img style="width:70%;" src="/assets2/img/ppcp.png" alt="Circle Image" class="rounded-circle img-raised">
								<h3 style="margin-top:-200px; color:#ffffff;"><b>PROGRAM PELATIHAN</b></h3>
								<h3 style="margin-top:-40px; margin-bottom:200px; color:#ffffff;"><b>CALON PEGAWAI (PPCP)</b></h3>
							</a>
						</div>
					</div> 
					-->

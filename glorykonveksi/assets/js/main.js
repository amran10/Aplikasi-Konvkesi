...
// tambahan agung
			document.getElementById('hadir').value = res.code;
			document.getElementById('hadiraa').style.display = 'inline';
			window.location='/barang/edit_e/' + document.getElementById('id_event').value + '~' + res.code;
// tambahan agung
        },

...
order by constraint_name, referenced_table_name, keyno";
	...
	*/
	...
	function _query($sql,$inputarr=false)
	{
		...
		$patterns[0] = '/sysdate/i';
		$replacement[0] = 'getdate()';
		$patterns[1] = '/trim/i';
		$replacement[1] = 'dbo.trim';
		$patterns[2] = '/to_date/i';
		$replacement[2] = 'dbo.to_date';
		$patterns[3] = '/to_char/i';
		$replacement[3] = 'dbo.to_char';
		$patterns[4] = '/\|\|/i';
		$replacement[4] = '+';
		$patterns[5] = '/substr/i';
		$replacement[5] = 'dbo.substr';
		$patterns[6] = '/nvl/i';
		$replacement[6] = 'dbo.nvl';
		
		$sql = preg_replace($patterns, $replacement, $sql);
		
		if (preg_match('/select count(1) as total from/i',$sql)) $sql .= ' a ';

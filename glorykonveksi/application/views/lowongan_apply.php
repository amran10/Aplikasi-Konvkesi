										...
										<div class="col-md-4" align="left">
											<div class="datepicker-container">
												<div class="form-group">
													<input readonly style="background-color : white;" Required id="tgl_lahir" name="tgl_lahir" type="text" class="form-control" value="<?php echo date('m/d/Y',strtotime($tgl_lahir)); ?>" id="tgl_lahir" name="tgl_lahir">
												</div>
											</div>
										</div>
										<div class="col-md-2"></div>
